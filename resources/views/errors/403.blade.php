...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <div class="flex flex-col items-center justify-center h-full min-h-[60vh]">
                    <h1 class="text-[6rem] xs:text-[8rem] sm:text-[10rem] md:text-[12rem] lg:text-[15rem] xl:text-[18rem] leading-none font-bold text-[#f53003] dark:text-[#FF4433]">
    403
</h1>
                    <!-- "Área Restrita" -->
                    <p class="text-4xl md:text-5xl lg:text-6xl font-medium text-[#706f6c] dark:text-[#A1A09A] mt-4">Área
                        Restrita</p>
                    <!-- Optional message -->
