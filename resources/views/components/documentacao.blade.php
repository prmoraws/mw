...
<head>
    ...
    @endif
        ...
        <div class="container mx-auto px-4 py-8">
            <h1 class="text-4xl font-bold text-gray-800 mb-6">Documentação da Aplicação MW</h1>

            <section class="mb-8">
                <h2 class="text-3xl font-semibold text-gray-700 mb-4">Objetivo e Visão</h2>
                <p class="text-gray-600 mb-4">
                    A aplicação foi desenvolvida com a finalidade de ser uma ferramenta eficaz para a gestão e
                    apresentação de dados.
                    Com ela, você poderá acessar informações de maneira prática e eficiente, facilitando a administração
                    dos dados que são essenciais para o
                    seu negócio ou projeto. A MW busca simplificar seu dia a dia, permitindo que você se concentre
                    no que realmente importa:
                    tomar decisões informadas com base em dados precisos e organizados.
                </p>
                <p class="text-gray-600 mb-4">
                    Aqui, esperamos que você encontre a solução ideal para suas necessidades de gestão, proporcionando
                    uma experiência de usuário
                    fluida e intuitiva em cada interação.
                </p>
            </section>

            <section>
                <h2 class="text-3xl font-semibold text-gray-700 mb-4">Como Acessar</h2>
                <p class="text-gray-600 mb-4">
                    Para começar a utilizar a MW, é necessário realizar um registro na plataforma. Após preencher
                    suas informações,
                    seu pedido será analisado. Se a sua solicitação for aprovada, você receberá um login e uma senha que
                    permitirá acessar toda a funcionalidade
                    da aplicação.
                </p>
                <p class="text-gray-600 mb-4">
                    Após a validação do seu registro e efetuar o login, você terá acesso a um sistema completo, que
                    facilitará a gestão de dados.
                    Com um design responsivo e amigável, a MW conta com um painel de controle, conhecido como
                    dashboard, onde você pode gerar relatórios
                    instantâneos para acompanhar a performance e as principais métricas que importam para o seu
                    trabalho.
                </p>
                <p class="text-gray-600 mb-4">
                    A importância de uma dashboard não pode ser subestimada. Com ela, você terá uma visão clara e
                    organizada dos dados, permitindo que
                    você identifique rapidamente tendências e áreas que necessitam de atenção. Um dashboard eficiente
                    pode transformar dados complexos
                    em informações acionáveis que ajudam na tomada de decisão e no planejamento estratégico.
                </p>
            </section>

            <footer class="mt-8">
                <p class="text-gray-600">
                    Desenvolvido por: <strong>J. M. Moraes</strong>
                </p>
            </footer>
        </div>
</body>
