    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <form wire:submit.prevent="search" class="max-w-lg mx-auto">
                        <div class="flex">
                            <input type="text" wire:model.debounce.500ms="searchTerm"
                                ...
                                placeholder="Pesquisar por nome da região...">
                            <button type="submit"
                ...
                @if ($confirmDeleteId)
                    <div wire:key="delete-modal" x-data="{ open: {{ $confirmDeleteId ? 'true' : 'false' }} }" x-show="open"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">Tem certeza que deseja apagar esta região?
                ...
                @if (!empty($results))
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        <table class="w-full table-auto border-collapse">
                            ...
                            <tbody>
                                @foreach ($results as $index => $regiao)
                                    <tr wire:key="table-row-{{ $regiao->id }}-{{ $index }}"
                    ...
                    <div class="md:hidden space-y-4">
                        @foreach ($results as $index => $regiao)
                            <div wire:key="card-{{ $regiao->id }}-{{ $index }}"
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400 text-sm mt-4">Nenhuma região encontrada. Use o campo
