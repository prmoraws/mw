                ...
                @if ($confirmDeleteId)
                    <div wire:key="delete-modal" x-data="{ open: {{ $confirmDeleteId ? 'true' : 'false' }} }" 
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">Tem certeza que deseja apagar este cargo? Esta ação não pode ser desfeita.</p>
                            <div class="flex justify-end gap-2">
                    ...
                    <table class="w-full table-auto border-collapse">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-700">
                                ...
                                <th scope="col" class="px-4 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Cargo</th>
                        ...
                        <tbody>
                            @foreach ($cargos as $index => $cargo)
                                <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }} dark:{{ $index % 2 == 0 ? 'bg-gray-800' : 'bg-gray-900' }}">
                                    <td class="border px-4 py-3 text-sm text-gray-700 dark:text-gray-200">{{ $cargo->id }}</td>
                                    <td class="border px-4 py-3 text-sm text-gray-700 dark:text-gray-200">{{ $cargo->nome }}</td>
                    ...
                    @foreach ($cargos as $cargo)
                        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm font-medium text-gray-900 dark:text-gray-100">No. {{ $cargo->id }}</p>
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $cargo->nome }}</p>
                                </div>
